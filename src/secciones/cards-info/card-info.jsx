...
import { faGlobe, faGears, faPalette, faHandHoldingDollar, faLock, faSyncAlt } from "@fortawesome/free-solid-svg-icons";
    ...
    <section className="py-4 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {servicios.map((servicio, index) => (
          <div key={index} className="flex flex-col items-center border border-gray-300 rounded p-4">
            <span className="text-4xl text-primary-color mb-4"><FontAwesomeIcon icon={servicio.icon} /></span>
