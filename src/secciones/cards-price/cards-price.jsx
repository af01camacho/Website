...
function CardsPrice() {
  ...
  return (
    <>
      ...
      <div className="grid md:grid-cols-1 lg:grid-cols-3 grid-cols-1 place-content-center gap-5 place-items-center">
        <div className="relative h-80 md:w-3/4 lg:w-[300px] w-3/4 rounded-md bg-white shadow-2xl">
