  ...
  return (
    <>
      <div className=" flex flex-col items-center justify-center h-[92%] w-[100%] absolute filter  backdrop-blur-sm	">
        <div className="bg-white dark:bg-gray-900 dark:text-white border border-gray-500 flex-col w-3/6 h-3/4 text-black rounded-xl p-2 flex  items-center gap-7">
          <h2 className="text-2xl font-semibold">Login</h2>
          <div className="flex flex-col gap-2">
            <label htmlFor="">Email</label>
            <input
              className="dark:bg-gray-600 border dark:border-none  p-2 rounded-sm outline-none w-96"
              type="email"
