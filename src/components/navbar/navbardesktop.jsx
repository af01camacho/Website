...
function NavbarDesktop({ changeDarkMode }) {
  ...
  return (
    <>
      <nav className="flex justify-around shadow-md p-4 items-center  ">
        <ul className=" text-md md:hidden lg:contents">
          <Link to="/">Home</Link>
          <Link>About</Link>
        ...
        <div>
          <h2 className="font-bold text-4xl">TechMastersWeb</h2>
        </div>
      ...
      <div
        className={
          toggle ? "transition-all  " : "transition-all absolute -translate-x-[5000px] "
        }
      >
        <LoginDesktop />
      </div>
